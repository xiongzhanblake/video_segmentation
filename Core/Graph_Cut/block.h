...
public:
	...
	Block(int size, void (*err_function)(const char *) = NULL) { first = last = NULL; block_size = size; error_function = err_function; scan_current_block = NULL; scan_current_data = NULL;}
